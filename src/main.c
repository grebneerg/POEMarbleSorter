...
#pragma config(Sensor, dgtl8,  quad,           sensorQuadEncoder)
#pragma config(Motor,  port1,           shooter,       tmotorVex393_HBridge, openLoop, encoderPort, dgtl8)
...
const int lowSpeed = -50; //TODO
const int medSpeed = -60; //TODO
